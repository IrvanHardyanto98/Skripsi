...
\newcommand{\nama}{Irvan Hardyanto}
\newcommand{\@npm}{2016730070}
\newcommand{\@judultopik}{Penemuan Flock Pattern Secara Online} % Judul/topik anda
\newcommand{\jumpemb}{1} % Jumlah pembimbing, 1 atau 2
\newcommand{\tanggal}{01/01/2021}
...
Menemukan pola (pattern) tertentu pada kumpulan data spasio-temporal dalam jumlah besar adalah pekerjaan yang tidak mudah. Hal ini karena pola spasio-temporal didefinisikan sebagai perubahan yang terjadi dari waktu ke waktu pada relasi spasial diantara objek-objek yang bergerak. 

Proses menemukan pattern dapat menemukan perilaku-perilaku penting yang melibatkan pergerakan benda yang sedang diamati(conthonya:  pola migrasi binatang liar, pola lalu lintas di jalan, dan aktivitas mencurigakan di perkotaan).
